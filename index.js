...
//MaximusBoys  Code
const IDler = {
  botID: "792827702985097237",
  botToken: "RbUphbNc7votpFA4gIK2uBIFYU5yNPHa",
  botSecret: "G6Iy1kfnjsFv4xlilaP5XJ5XeXQZJgG5",
  botCallbackURL: "https://corbacodeshare.glitch.me/callback",
  callbackurl: "https://corbacodeshare.glitch.me/callback",
  sunucuID: "774646949118869546",
  sunucuDavet: "https://discord.gg/DvRcFnDxrY",
  kodLogKanalı: "793011591439319080",
  sahipRolü: "782311176855224330",
  adminRolü: "774647943508656188",
  kodPaylaşımcıRolü: "782271141858639872",
  boosterRolü: "788084890146701313",
  kodPaylaşamayacakRoller: ["774654724989386772", "782170175520243723", "782574612831010858"],
  hazırAltyapılarRolü: "782170175520243723",
  hazırSistemlerRolü: "782170175520243723",
  elmasKodlarRolü: "782170175520243723",
  altınKodlarRolü: "782170175520243723",
  normalKodlarRolü: "782170175520243723"
};
//MaximusBoys  Code
const app = express();
...
app.post("/paylasim", (req, res) => {
  ...
  client.channels.cache.get(IDler.kodLogKanalı).send(
    ...
    .addField("> Kod Sayfası", `[Tıkla!](https://corbacodeshare.glitch.me/${obj.kod_rank}/${obj.id})`));
